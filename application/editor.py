import sys
import pandas as pd
from PyQt6.QtWidgets import QApplication, QWidget, QTableWidget, QTableWidgetItem, QHeaderView, QLineEdit, QPushButton, QItemDelegate, QVBoxLayout
...
class TableWidget(QTableWidget):
    def __init__(self, df):
        ...
        self.setHorizontalHeaderLabels(('Date', 'Time', 'Score'))
